...
class __TwigTemplate_6945aee7a3699ee1c2c074c710478617 extends Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap3/templates/input/input--button.html.twig", "/var/www/web/themes/contrib/bootstrap3/templates/input/input--button.html.twig");
    }
