...
use Drupal\bootstrap3\Plugin\Setting\SettingInterface;
...
$bootstrap = Bootstrap::getTheme('bootstrap3');

/** @var \Drupal\bootstrap3\Plugin\Setting\SettingInterface[] $settings */
