...
class PluginCallback extends PluginID {
   ...
   *
   * @var \Drupal\bootstrap3\Annotation\BootstrapConstant
   *
   * Must be one of the following constants:
   *   - \Drupal\bootstrap3\Bootstrap::CALLBACK_APPEND
   *   - \Drupal\bootstrap3\Bootstrap::CALLBACK_PREPEND
   *   - \Drupal\bootstrap3\Bootstrap::CALLBACK_REPLACE_APPEND
   *   - \Drupal\bootstrap3\Bootstrap::CALLBACK_REPLACE_PREPEND
   * Use with @ BootstrapConstant annotation.
   *
   * @see \Drupal\bootstrap3\Bootstrap::addCallback()
   */
