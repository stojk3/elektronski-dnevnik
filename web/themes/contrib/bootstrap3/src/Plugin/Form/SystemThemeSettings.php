...
namespace Drupal\bootstrap3\Plugin\Form;
...
class SystemThemeSettings extends FormBase implements FormInterface {
  ...
  protected function createGroups(Element $form, FormStateInterface $form_state) {
    ...
    $form['bootstrap'] = [
      '#type' => 'vertical_tabs',
      '#attached' => ['library' => ['bootstrap3/theme-settings']],
      '#prefix' => '<h2><small>' . t('Bootstrap 3 Settings') . '</small></h2>',
      '#weight' => -10,
    ];
    $groups = [
      'general' => t('General'),
   ...
   *   The current state of the form.
   *
   * @return \Drupal\bootstrap3\Theme|false
