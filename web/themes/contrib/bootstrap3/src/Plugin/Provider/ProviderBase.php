...
class ProviderBase extends PluginBase implements ProviderInterface {
   ...
   * @var int[]
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface
   */
  protected $cacheTtl = [];
   ...
   *
   * @var \Drupal\bootstrap3\Plugin\Provider\CdnAssets[]
   */
  protected $cdnAssets;
   ...
   *
   * @var \Drupal\bootstrap3\Plugin\Provider\ProviderException[]
   */
   ...
   * {@inheritdoc}
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderBase::getCdnAssetsCacheData()
   */
   ...
   *   \Drupal\bootstrap3\Plugin\Provider\ProviderBase::discoverCdnAssets(), but
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderBase::getCdnAssets()
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderBase::alterFrameworkLibrary()
   */
