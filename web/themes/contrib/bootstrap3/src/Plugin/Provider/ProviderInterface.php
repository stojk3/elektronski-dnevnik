...
interface ProviderInterface extends PluginInspectionInterface, DerivativeInspectionInterface {
   ...
   *   - \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::CACHE_ASSETS
   *   - \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::CACHE_LIBRARY
   *   - \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::CACHE_THEMES
   *   - \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::CACHE_VERSIONS
   ...
   *   retrieved.
   *
   * @return \Drupal\bootstrap3\Plugin\Provider\ProviderException[]
   ...
   *   \Drupal\bootstrap3\Plugin\Provider\ProviderBase::getCdnAssets(), but
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::getCdnAssets()
   */
   ...
   * @deprecated in 8.x-3.18, will be removed in a future release.
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::getCdnThemes()
   */
   ...
   * @deprecated in 8.x-3.18, will be removed in a future release.
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::getCdnVersions()
   */
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::getCdnExceptions()
   */
