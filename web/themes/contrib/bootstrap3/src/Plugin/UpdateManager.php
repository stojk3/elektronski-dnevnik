...
class UpdateManager extends PluginManager {
  ...
  /**
   * Constructs a new \Drupal\bootstrap3\Plugin\UpdateManager object.
   *
  ...
  public function __construct(Theme $theme) {
    ...
    $this->pluginDefinitionAnnotationName = 'Drupal\bootstrap3\Annotation\BootstrapUpdate';
    $this->pluginInterface = 'Drupal\bootstrap3\Plugin\Update\UpdateInterface';
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\UpdateManager::getLatestSchema
   */
