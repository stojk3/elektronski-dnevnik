...
use Drupal\bootstrap3\Utility\SortArray;
...
class SettingManager extends PluginManager {
  ...
  /**
   * Constructs a new \Drupal\bootstrap3\Plugin\SettingManager object.
   *
   * @param \Drupal\bootstrap3\Theme $theme
   *   The theme to use for discovery.
   */
  public function __construct(Theme $theme) {
    parent::__construct($theme, 'Plugin/Setting', 'Drupal\bootstrap3\Plugin\Setting\SettingInterface', 'Drupal\bootstrap3\Annotation\BootstrapSetting');
