...
class ThemeSuggestions extends PluginBase implements AlterInterface {
   ...
   *
   * @var \Drupal\bootstrap3\Utility\Element|false
   */
  protected $element;
   ...
   *
   * @var \Drupal\bootstrap3\Utility\Variables
   */
  protected $variables;
   ...
   * @param \Drupal\bootstrap3\Utility\Variables $variables
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\Alter\ThemeSuggestions::addSuggestionsForEntity
   */
   ...
   * @deprecated Since 8.x-3.2. Will be removed in a future release.
   *
   * @see \Drupal\bootstrap3\Plugin\Alter\ThemeSuggestions::getEntityObject
   */
