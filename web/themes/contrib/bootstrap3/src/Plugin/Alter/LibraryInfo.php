    ...
    elseif ($extension === 'core') {
      ...
      if ($this->theme->getSetting('modal_enabled')) {
        ...
        if ($this->theme->getSetting('modal_jquery_ui_bridge')) {
          ...
          $libraries['drupal.dialog']['dependencies'][] = 'bootstrap3/dialog';
          $libraries['drupal.dialog']['dependencies'][] = 'bootstrap3/modal.jquery.ui.bridge';
        }
        // Otherwise, just append the modal.
        else {
          $libraries['drupal.dialog']['dependencies'][] = 'bootstrap3/modal';
          $libraries['drupal.dialog']['dependencies'][] = 'bootstrap3/dialog';
        }
      }
    }
