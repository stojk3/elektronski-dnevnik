...
use Drupal\bootstrap3\Plugin\Form\FormInterface;
...
interface SettingInterface extends PluginInspectionInterface, FormInterface {
   ...
   *
   * @see \Drupal\bootstrap3\Plugin\Setting\SettingBase::drupalSettings()
   *
   * @return bool
   *   TRUE or FALSE
   */
   ...
   *
   * @deprecated Will be removed in a future release. Use \Drupal\bootstrap3\Plugin\Setting\SettingInterface::getGroupElement
   */
   ...
   * Retrieves the group form element the setting belongs to.
   *
   * @param \Drupal\bootstrap3\Utility\Element $form
   ...
   *
   * @deprecated Will be removed in a future release. Use \Drupal\bootstrap3\Plugin\Setting\SettingInterface::getSettingElement
   */
   ...
   * @param \Drupal\bootstrap3\Plugin\Setting\DeprecatedSettingInterface[] $deprecated
