...
use Drupal\bootstrap3\Plugin\SettingManager;
use Drupal\bootstrap3\Plugin\UpdateManager;
use Drupal\bootstrap3\Utility\Crypt;
use Drupal\bootstrap3\Utility\Storage;
use Drupal\bootstrap3\Utility\StorageItem;
...
class Theme {
   ...
   *
   * @see \Drupal\bootstrap3\Theme::IGNORE_ASSETS
   * @see \Drupal\bootstrap3\Theme::IGNORE_CORE
   * @see \Drupal\bootstrap3\Theme::IGNORE_DOCS
   * @see \Drupal\bootstrap3\Theme::IGNORE_DEV
   */
   ...
   *
   * @var \Drupal\bootstrap3\Plugin\Provider\ProviderInterface[]
   */
   ...
   *
   * @var \Drupal\bootstrap3\Plugin\Setting\SettingInterface[]
   */
  protected $settings;
   ...
   *
   * @var \Drupal\bootstrap3\Plugin\UpdateManager
   */
  ...
  public function __construct(Extension $theme, ThemeHandlerInterface $theme_handler) {
    ...
    $this->bootstrap = $this->subthemeOf('bootstrap3');
   ...
   *     - \Drupal\bootstrap3::IGNORE_CORE
   *     - \Drupal\bootstrap3::IGNORE_ASSETS
   *     - \Drupal\bootstrap3::IGNORE_DOCS
   *     - \Drupal\bootstrap3::IGNORE_DEV
   *     - \Drupal\bootstrap3::IGNORE_THEME
   ...
   *
   * @return \Drupal\bootstrap3\Theme[]
   *   An associative array of \Drupal\bootstrap3 objects (theme), keyed
   *   by machine name.
   */
   ...
   *
   * @return mixed|\Drupal\bootstrap3\Utility\StorageItem
   ...
   *
   * @return \Drupal\bootstrap3\Plugin\Provider\ProviderInterface
   ...
   *
   * @return \Drupal\bootstrap3\Plugin\Update\UpdateInterface[]
   ...
   *   the settings.
   *
   * @return \Drupal\bootstrap3\Plugin\Setting\SettingInterface|\Drupal\bootstrap3\Plugin\Setting\SettingInterface[]|null
   ...
   *
   * @return \Drupal\bootstrap3\Utility\Storage
   *   The cache object.
   */
   ...
   *
   * @return \Drupal\bootstrap3\Plugin\UpdateManager|false
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\bootstrap3\Theme::dev
   */
   ...
   *
   * @see \Drupal\bootstrap3\Theme::livereload
   *
   * @return string
   *   The livereload URL.
   */
   ...
   *
   * @return \Drupal\bootstrap3\ThemeSettings
   *   All settings.
   */
   ...
   *
   * @param string|\Drupal\bootstrap3\Theme $theme
   ...
   *
   * @return \Drupal\bootstrap3\Plugin\Provider\ProviderInterface|false
   ...
   *
   * @see \Drupal\bootstrap3\Theme::getSettingPlugin()
   */
