...
namespace Drupal\bootstrap3\Utility;
...
class Element extends DrupalAttributes {
   ...
   *
   * @return \Drupal\bootstrap3\Utility\Element
  ...
  public function &__get($key) {
    if (CoreElement::property($key)) {
      throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Please use \Drupal\bootstrap3\Utility\Element::getProperty instead.');
    }
  ...
  public function __set($key, $value) {
    if (CoreElement::property($key)) {
      throw new \InvalidArgumentException('Cannot dynamically retrieve element property. Use \Drupal\bootstrap3\Utility\Element::setProperty instead.');
    }
  ...
  public function __isset($name) {
    if (CoreElement::property($name)) {
      throw new \InvalidArgumentException('Cannot dynamically check if an element has a property. Use \Drupal\bootstrap3\Utility\Element::unsetProperty instead.');
    }
  ...
  public function __unset($name) {
    if (CoreElement::property($name)) {
      throw new \InvalidArgumentException('Cannot dynamically unset an element property. Use \Drupal\bootstrap3\Utility\Element::hasProperty instead.');
    }
    parent::__unset($name);
  }
  ...
  /**
   * Creates a new \Drupal\bootstrap3\Utility\Element instance.
   *
   * @param array|string $element
  ...
  /**
   * Creates a new standalone \Drupal\bootstrap3\Utility\Element instance.
   *
   ...
   *
   * @param array|string|\Drupal\bootstrap3\Utility\Element $element
   ...
   *
   * @return \Drupal\bootstrap3\Utility\Element|false
   ...
   *
   * @param array|\Drupal\bootstrap3\Utility\Element|null $target_element
  ...
  public function smartDescription(&$target_element = NULL, $input_only = TRUE, $length = NULL) {
    ...
    /** @var \Drupal\bootstrap3\Utility\Element $target */
