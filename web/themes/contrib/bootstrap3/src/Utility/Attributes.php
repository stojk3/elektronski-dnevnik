...
class Attributes extends ArrayObject {
   ...
   *
   * @see \Drupal\bootstrap3\Utility\Attributes::getClasses()
   */
   ...
   *
   * @see \Drupal\bootstrap3\Utility\ArrayObject::offsetGet()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\bootstrap3\Utility\ArrayObject::offsetExists()
   */
   ...
   *
   * @see \Drupal\bootstrap3\Utility\ArrayObject::offsetUnset()
   */
   ...
   *
   * @see \Drupal\bootstrap3\Utility\ArrayObject::offsetSet()
   */
   ...
   *
   * @see \Drupal\bootstrap3\Utility\ArrayObject::merge()
   */
