...
use Drupal\bootstrap3\Plugin\ProviderManager;
use Drupal\bootstrap3\Utility\Element;
use Drupal\bootstrap3\Utility\Unicode;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Plugin\ProviderManager::FILE_PATH
 */
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Bootstrap::FRAMEWORK_VERSION
 */
 ...
 * @code
 *   // Before.
 *   _bootstrap3_add_class('my-class', $element);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::addClass()
 */
function _bootstrap3_add_class($class, array &$element, $property = 'attributes') {
 ...
 * @code
 *   // Before.
 *   _bootstrap3_colorize_button($element);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::colorize()
 * */
function _bootstrap3_colorize_button(array &$element) {
  Bootstrap::deprecated();
  Element::create($element)->colorize();
}
 ...
 * @code
 *   // Before.
 *   $class = _bootstrap3_colorize_text($string, $default);
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Bootstrap::cssClassFromString()
 */
function _bootstrap3_colorize_text($string, $default = '') {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   $files = _bootstrap3_file_scan_directory($theme_path . '/js', '/\.js$/');
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Theme::fileScan()
 * @see file_scan_directory()
 */
function _bootstrap3_file_scan_directory($dir, $mask, array $options = []) {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::getAttributes()
 */
 ...
 *   $base_themes = _bootstrap3_get_base_themes(NULL, TRUE);
 *
 *   // Before (excluding active theme).
 *   $base_themes = _bootstrap3_get_base_themes('my_subtheme');
 *
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Theme::getAncestry()
 */
function _bootstrap3_get_base_themes($theme_key = NULL, $include_theme_key = FALSE) {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::getClasses()
 */
 ...
 * _bootstrap3_icon() implementation since it didn't return a render array. It
 ...
 * @code
 *   // Before.
 *   $icon = _bootstrap3_glyphicon($name, $default, $attributes);
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @see \Drupal\bootstrap3\Bootstrap::glyphicon()
 * @see \Drupal\bootstrap3\Utility\Element::createStandalone()
 */
function _bootstrap3_glyphicon($name, $default = [], array $attributes = []) {
  Bootstrap::deprecated();
  $icon = Bootstrap::glyphicon($name, ['#markup' => $default]);
  $icon_attributes = isset($icon['#attributes']) ? $icon['#attributes'] : [];
  unset($icon['#attributes']);
 ...
 * @code
 *   // Before.
 *   $glyphicons = _bootstrap3_glyphicons($version);
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Bootstrap::glyphicons()
 */
function _bootstrap3_glyphicons($version = NULL) {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   $supported = _bootstrap3_glyphicons_supported();
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 *   $theme = Bootstrap::getTheme();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Theme::hasGlyphicons()
 */
function _bootstrap3_glyphicons_supported() {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   $icon = _bootstrap3_icon($name, $default, $attributes);
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @see \Drupal\bootstrap3\Utility\Element::createStandalone()
 */
function _bootstrap3_icon($name, $default = NULL, array $attributes = []) {
  Bootstrap::deprecated();
  $icon = Bootstrap::glyphicon($name, ['#markup' => $default]);
  $icon_attributes = isset($icon['#attributes']) ? $icon['#attributes'] : [];
  unset($icon['#attributes']);
 ...
 * @code
 *   // Before.
 *   _bootstrap3_iconize_button($element);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::setIcon()
 */
function _bootstrap3_iconize_button(array &$element) {
  Bootstrap::deprecated();
  Element::create($element)->setIcon();
}
 ...
 * @code
 *   // Before.
 *   $icon = _bootstrap3_iconize_text($string, $default);
 *
 *   // After.
 *   use Drupal\bootstrap3\Bootstrap;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Bootstrap::glyphiconFromString()
 */
function _bootstrap3_iconize_text($string, $default = '') {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   $button = _bootstrap3_is_button($element);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::isButton()
 */
function _bootstrap3_is_button(array $element) {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   $simple = _bootstrap3_is_simple_string($string, $length, $allowed_tags, $html);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Unicode;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Unicode::isSimple()
 */
function _bootstrap3_is_simple_string($string, $length = 250, $allowed_tags = NULL, &$html = FALSE) {
  Bootstrap::deprecated();
 ...
 * @code
 *   // Before.
 *   _bootstrap3_remove_class('my-class', $element);
 *
 *   // After.
 *   use Drupal\bootstrap3\Utility\Element;
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::removeClass()
 */
function _bootstrap3_remove_class($class, array &$element, $property = 'attributes') {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Plugin\ProviderManager
 * @see \Drupal\bootstrap3\Theme::getCdnProviders()
 * @see \Drupal\bootstrap3\Theme::getCdnProvider()
 */
function bootstrap3_cdn_provider($provider = NULL, $reset = FALSE) {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Utility\Element::smartDescription()
 */
function bootstrap3_element_smart_description(array &$element, array &$target = NULL, $input_only = TRUE, $length = NULL) {
  Bootstrap::deprecated();
  Element::create($element)->smartDescription($target, $input_only, $length);
}
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Plugin\Provider\Custom::getAssets()
 * @see \Drupal\bootstrap3\Plugin\Provider\JsDelivr::getAssets()
 * @see \Drupal\bootstrap3\Plugin\Provider\ProviderBase::getAssets()
 * @see \Drupal\bootstrap3\Plugin\Provider\ProviderInterface::getAssets()
 * @see \Drupal\bootstrap3\Plugin\ProviderManager::load()
 */
function bootstrap3_get_cdn_assets($type = NULL, $provider = NULL, $theme = NULL) {
  Bootstrap::deprecated();
  $original_type = $type;
  $return = [];
  $config = \Drupal::config('system.performance');
 ...
 * @deprecated Will be removed in a future release. There is no replacement.
 */
function bootstrap3_get_theme_info($theme_key = NULL, $key = NULL, $base_themes = TRUE) {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Theme::includeOnce()
 * @see \Drupal\bootstrap3\Bootstrap::getTheme()
 */
function bootstrap3_include($theme, $path) {
  Bootstrap::deprecated();
 ...
 * @endcode
 *
 * @see \Drupal\bootstrap3\Theme::getSetting()
 * @see \Drupal\bootstrap3\Bootstrap::getTheme()
 */
function bootstrap3_setting($name, $theme = NULL, $prefix = 'bootstrap', $default = NULL) {
  Bootstrap::deprecated();
  $theme = Bootstrap::getTheme($theme);
